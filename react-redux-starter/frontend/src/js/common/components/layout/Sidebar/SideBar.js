            ...
            <aside className={`main-sidebar px-0 col-12 col-md-3 col-lg-2 ${toggleOpen?'':'open'}`}>
                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        ...
                        <li className="nav-item">
                            <NavLink to="/explorar" exact className="nav-link " activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">view_module</i>
                                </div>
                        ...
                        <li className="nav-item">
                            <NavLink to="/misventas" exact className="nav-link " activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                        ...
                        <li className="nav-item">
                            <NavLink to="/miscompras" exact className="nav-link " activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
